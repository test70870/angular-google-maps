...
import * as ɵngcc1 from './../services/managers/data-layer-manager';
let layerId = 0;
/**
...
AgmDataLayer.ɵfac = function AgmDataLayer_Factory(t) { return new (t || AgmDataLayer)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DataLayerManager)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AgmDataLayer, [{
    ...
    }], function () { return [{ type: ɵngcc1.DataLayerManager }]; }, { layerClick: [{
            type: Output
        }], geoJson: [{
            type: Input
        }], style: [{
